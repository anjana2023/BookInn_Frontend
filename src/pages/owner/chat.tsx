...
import Conversation from "../../chat/owner/conversation";
import Message from "../../chat/owner/Message";
import Navbar from "../../components/owner/Navbar/Navbar";
import { FiSend } from "react-icons/fi";
import { useAppSelector } from "../../redux/store/store";
import axiosJWT from "../../utils/axiosService";
import { CHAT_API, OWNER_API } from "../../constants";
import { useSocket } from "../../redux/Context/SocketContext";

const Chat: React.FC = () => {
  const doctor = useAppSelector((state) => state.ownerSlice);
  ...
  const handleConversationClick = async (conversation: any) => {
    ...
    try {
      const response = await axiosJWT.get(`${OWNER_API}/user/${id}`);
